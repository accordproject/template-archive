...
The Accord Project technology is being developed as open source under the [Apache-2 license](https://www.apache.org/licenses/LICENSE-2.0.html). All the software packages are being actively maintained on GitHub and we encourage organizations and individuals to contribute requirements, documentation, issues, new templates, and code.
