...
yargs
    ...
    .recommendCommands()
    .strict()
    .command('verify', 'verify the template signatures of the template author/developer', (yargs: any) => {
    ...
    .command('archive', 'create a template archive', (yargs: any) => {
        yargs.option('template', {
            describe: 'path to the template',
            type: 'string'
        });
    ...
    .command('draft', 'create sample text by merging a template with data', (yargs: any) => {
        yargs.option('template', {
            describe: 'path to the template',
            type: 'string'
        });
    ...
    .command('compile', 'generate code for a target platform', (yargs: any) => {
        yargs.option('template', {
            describe: 'path to the template',
            type: 'string'
        });
    ...
    .command('get', 'save local copies of external dependencies', (yargs: any) => {
        yargs.option('template', {
            describe: 'path to the template',
            type: 'string'
        });
