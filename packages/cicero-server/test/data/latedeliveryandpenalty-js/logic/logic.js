...
class orgXaccordprojectXlatedeliveryandpenaltyXLateDeliveryAndPenalty {
    ...
    if (either(res1)) {
      ...
      if (!(dateTimeIsBefore(vp1, vp2))) {
        ...
        if (!((!(deref(unbrand(vcontract), "forceMajeure")) || !(deref(unbrand(vrequest), "forceMajeure"))))) {
          t61 = {"left" : concat(concat({"response": brand(["org.accordproject.latedeliveryandpenalty.LateDeliveryAndPenaltyResponse"],concat({"penalty": 0}, {"buyerMayTerminate": true}))}, {"state": vlstate}), {"emit": vlemit})};
        } else {
          var vx = vnow;
          var vy = vagreed;
          var vz = "days";
          ...
          if (equal(vu, deref(unbrand(vdu$0), "unit"))) {
            ...
            if (either(t2)) {
              ...
              if (either(t3)) {
                ...
                var vX$0 = vX$case0_0;
                res10 = natMult(deref(unbrand(vdu$0), "amount"), 60);
              } else {
                var vX$case1_2 = null;
                ...
                if (either(t4)) {
                  ...
                  vX$1 = toLeft(t4);
                  var vX$2 = vX$1;
                  res9 = natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60);
                } else {
                  var vX$case1_1 = null;
                  ...
                  if (either(t5)) {
                    ...
                    vX$3 = toLeft(t5);
                    var vX$4 = vX$3;
                    res8 = natMult(natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60), 24);
                  } else {
                    var vX$case1_0 = null;
                    ...
                    if (either(t6)) {
                      ...
                      vX$5 = toLeft(t6);
                      var vX$6 = vX$5;
                      res7 = natMult(natMult(natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60), 24), 7);
                    } else {
                      var vX$7 = null;
                      vX$7 = toRight(t6);
              ...
              if (either(t11)) {
                ...
                if (either(t12)) {
                  ...
                  vX$B = toLeft(t12);
                  var vX$C = vX$B;
                  res19 = natDiv(deref(unbrand(vdu$0), "amount"), 60);
                } else {
                  var vX$D = null;
                  vX$D = toRight(t12);
                  var t13;
                  ...
                  if (either(t13)) {
                    ...
                    vX$E = toLeft(t13);
                    var vX$F = vX$E;
                    res18 = natMult(deref(unbrand(vdu$0), "amount"), 60);
                  } else {
                    var vX$10 = null;
                    vX$10 = toRight(t13);
                    var t14;
                    ...
                    if (either(t14)) {
                      ...
                      vX$11 = toLeft(t14);
                      var vX$12 = vX$11;
                      res17 = natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 24);
                    } else {
                      var vX$13 = null;
                      vX$13 = toRight(t14);
                      var t15;
                      ...
                      if (either(t15)) {
                        ...
                        vX$14 = toLeft(t15);
                        var vX$15 = vX$14;
                        res16 = natMult(natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 24), 7);
                      } else {
                        var vX$16 = null;
                        vX$16 = toRight(t15);
                        res16 = natMult(deref(unbrand(vdu$0), "amount"), 60);
                      }
                      res17 = res16;
                    }
                    res18 = res17;
                ...
                if (either(t20)) {
                  ...
                  if (either(t21)) {
                    ...
                    vX$1A = toLeft(t21);
                    var vX$1B = vX$1A;
                    res28 = natDiv(natDiv(deref(unbrand(vdu$0), "amount"), 60), 60);
                  } else {
                    var vX$1C = null;
                    vX$1C = toRight(t21);
                    var t22;
                    ...
                    if (either(t22)) {
                      ...
                      vX$1D = toLeft(t22);
                      var vX$1E = vX$1D;
                      res27 = natMult(deref(unbrand(vdu$0), "amount"), 60);
                    } else {
                      var vX$1F = null;
                      vX$1F = toRight(t22);
                      var t23;
                      ...
                      if (either(t23)) {
                        ...
                        vX$20 = toLeft(t23);
                        var vX$21 = vX$20;
                        res26 = natMult(deref(unbrand(vdu$0), "amount"), 24);
                      } else {
                        var vX$22 = null;
                        vX$22 = toRight(t23);
                        var t24;
                        ...
                        if (either(t24)) {
                          ...
                          vX$23 = toLeft(t24);
                          var vX$24 = vX$23;
                          res25 = natMult(natMult(deref(unbrand(vdu$0), "amount"), 24), 7);
                        } else {
                          var vX$25 = null;
                          vX$25 = toRight(t24);
                          res25 = natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60);
                        }
                        res26 = res25;
                      }
                      res27 = res26;
                  ...
                  if (either(t29)) {
                    ...
                    if (either(t30)) {
                      ...
                      vX$29 = toLeft(t30);
                      var vX$2A = vX$29;
                      res37 = natDiv(natDiv(natDiv(deref(unbrand(vdu$0), "amount"), 60), 60), 24);
                    } else {
                      var vX$2B = null;
                      vX$2B = toRight(t30);
                      var t31;
                      ...
                      if (either(t31)) {
                        ...
                        vX$2C = toLeft(t31);
                        var vX$2D = vX$2C;
                        res36 = natDiv(natMult(deref(unbrand(vdu$0), "amount"), 60), 24);
                      } else {
                        var vX$2E = null;
                        vX$2E = toRight(t31);
                        var t32;
                        ...
                        if (either(t32)) {
                          ...
                          vX$2F = toLeft(t32);
                          var vX$30 = vX$2F;
                          res35 = natDiv(deref(unbrand(vdu$0), "amount"), 24);
                        } else {
                          var vX$31 = null;
                          vX$31 = toRight(t32);
                          var t33;
                          ...
                          if (either(t33)) {
                            ...
                            vX$32 = toLeft(t33);
                            var vX$33 = vX$32;
                            res34 = natMult(deref(unbrand(vdu$0), "amount"), 7);
                          } else {
                            var vX$34 = null;
                            vX$34 = toRight(t33);
                            res34 = natDiv(natDiv(natDiv(deref(unbrand(vdu$0), "amount"), 60), 60), 24);
                          }
                          res35 = res34;
                        }
                        res36 = res35;
                    ...
                    if (either(t38)) {
                      ...
                      if (either(t39)) {
                        ...
                        vX$38 = toLeft(t39);
                        var vX$39 = vX$38;
                        res46 = natDiv(natDiv(natDiv(natDiv(deref(unbrand(vdu$0), "amount"), 60), 60), 24), 7);
                      } else {
                        var vX$3A = null;
                        vX$3A = toRight(t39);
                        var t40;
                        ...
                        if (either(t40)) {
                          ...
                          vX$3B = toLeft(t40);
                          var vX$3C = vX$3B;
                          res45 = natDiv(natDiv(natMult(deref(unbrand(vdu$0), "amount"), 60), 24), 7);
                        } else {
                          var vX$3D = null;
                          vX$3D = toRight(t40);
                          var t41;
                          ...
                          if (either(t41)) {
                            ...
                            vX$3E = toLeft(t41);
                            var vX$3F = vX$3E;
                            res44 = natDiv(natDiv(deref(unbrand(vdu$0), "amount"), 24), 7);
                          } else {
                            var vX$40 = null;
                            vX$40 = toRight(t41);
                            var t42;
                            ...
                            if (either(t42)) {
                              ...
                              vX$41 = toLeft(t42);
                              var vX$42 = vX$41;
                              res43 = natDiv(deref(unbrand(vdu$0), "amount"), 7);
                            } else {
                              var vX$43 = null;
                              vX$43 = toRight(t42);
                              res43 = natDiv(natDiv(natDiv(natDiv(deref(unbrand(vdu$0), "amount"), 60), 60), 24), 7);
                            }
                            res44 = res43;
                          }
                          res45 = res44;
                      ...
                      if (either(t47)) {
                        ...
                        vX$45 = toLeft(t47);
                        var vX$46 = vX$45;
                        res54 = natMult(deref(unbrand(vdu$0), "amount"), 60);
                      } else {
                        var vX$47 = null;
                        vX$47 = toRight(t47);
                        var t48;
                        ...
                        if (either(t48)) {
                          ...
                          vX$48 = toLeft(t48);
                          var vX$49 = vX$48;
                          res53 = natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60);
                        } else {
                          var vX$4A = null;
                          vX$4A = toRight(t48);
                          var t49;
                          ...
                          if (either(t49)) {
                            ...
                            vX$4B = toLeft(t49);
                            var vX$4C = vX$4B;
                            res52 = natMult(natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60), 24);
                          } else {
                            var vX$4D = null;
                            vX$4D = toRight(t49);
                            var t50;
                            ...
                            if (either(t50)) {
                              ...
                              vX$4E = toLeft(t50);
                              var vX$4F = vX$4E;
                              res51 = natMult(natMult(natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60), 24), 7);
                            } else {
                              var vX$50 = null;
                              vX$50 = toRight(t50);
          ...
          var vpenalty = ((((floatOfNat(vp0$0) / floatOfNat(vp0$1)) * deref(unbrand(vcontract), "penaltyPercentage")) / 100) * deref(unbrand(vrequest), "goodsValue"));
          var vp0$2 = bunion([vpenalty], [((deref(unbrand(vcontract), "capPercentage") * deref(unbrand(vrequest), "goodsValue")) / 100)]);
      ...
      var vX$51 = null;
      vX$51 = toRight(res1);
      res63 = {"right" : {"type": ["org.accordproject.ergo.stdlib.ErgoErrorResponse"], "data": {"message": "DefaultMatch Error at 7:0-36:1 ''"}}};
    }
    return res63;
  }
  init(context) {
  ...
  latedeliveryandpenalty(context) {
    ...
    if (!(dateTimeIsBefore(vp1, vp2))) {
      ...
      var t60;
      if (!((!(deref(unbrand(vcontract), "forceMajeure")) || !(deref(unbrand(vrequest), "forceMajeure"))))) {
        t60 = {"left" : concat(concat({"response": brand(["org.accordproject.latedeliveryandpenalty.LateDeliveryAndPenaltyResponse"],concat({"penalty": 0}, {"buyerMayTerminate": true}))}, {"state": vlstate}), {"emit": vlemit})};
      } else {
        var vx = vnow;
        var vy = vagreed;
        var vz = "days";
        ...
        if (equal(vu, deref(unbrand(vdu$0), "unit"))) {
          ...
          if (either(t1)) {
            ...
            if (either(t2)) {
              ...
              res9 = natMult(deref(unbrand(vdu$0), "amount"), 60);
            } else {
              var vX$case1_2 = null;
              ...
              if (either(t3)) {
                ...
                vX$0 = toLeft(t3);
                var vX$1 = vX$0;
                res8 = natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60);
              } else {
                var vX$case1_1 = null;
                ...
                if (either(t4)) {
                  ...
                  vX$2 = toLeft(t4);
                  var vX$3 = vX$2;
                  res7 = natMult(natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60), 24);
                } else {
                  var vX$case1_0 = null;
                  ...
                  if (either(t5)) {
                    ...
                    vX$4 = toLeft(t5);
                    var vX$5 = vX$4;
                    res6 = natMult(natMult(natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60), 24), 7);
                  } else {
                    var vX$case1 = null;
                    vX$case1 = toRight(t5);
            ...
            if (either(t10)) {
              ...
              if (either(t11)) {
                ...
                vX$9 = toLeft(t11);
                var vX$A = vX$9;
                res18 = natDiv(deref(unbrand(vdu$0), "amount"), 60);
              } else {
                var vX$B = null;
                vX$B = toRight(t11);
                var t12;
                ...
                if (either(t12)) {
                  ...
                  vX$C = toLeft(t12);
                  var vX$D = vX$C;
                  res17 = natMult(deref(unbrand(vdu$0), "amount"), 60);
                } else {
                  var vX$E = null;
                  vX$E = toRight(t12);
                  var t13;
                  ...
                  if (either(t13)) {
                    ...
                    vX$F = toLeft(t13);
                    var vX$10 = vX$F;
                    res16 = natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 24);
                  } else {
                    var vX$11 = null;
                    vX$11 = toRight(t13);
                    var t14;
                    ...
                    if (either(t14)) {
                      ...
                      vX$12 = toLeft(t14);
                      var vX$13 = vX$12;
                      res15 = natMult(natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 24), 7);
                    } else {
                      var vX$14 = null;
                      vX$14 = toRight(t14);
                      res15 = natMult(deref(unbrand(vdu$0), "amount"), 60);
                    }
                    res16 = res15;
                  }
                  res17 = res16;
              ...
              if (either(t19)) {
                ...
                if (either(t20)) {
                  ...
                  vX$18 = toLeft(t20);
                  var vX$19 = vX$18;
                  res27 = natDiv(natDiv(deref(unbrand(vdu$0), "amount"), 60), 60);
                } else {
                  var vX$1A = null;
                  vX$1A = toRight(t20);
                  var t21;
                  ...
                  if (either(t21)) {
                    ...
                    vX$1B = toLeft(t21);
                    var vX$1C = vX$1B;
                    res26 = natMult(deref(unbrand(vdu$0), "amount"), 60);
                  } else {
                    var vX$1D = null;
                    vX$1D = toRight(t21);
                    var t22;
                    ...
                    if (either(t22)) {
                      ...
                      vX$1E = toLeft(t22);
                      var vX$1F = vX$1E;
                      res25 = natMult(deref(unbrand(vdu$0), "amount"), 24);
                    } else {
                      var vX$20 = null;
                      vX$20 = toRight(t22);
                      var t23;
                      ...
                      if (either(t23)) {
                        ...
                        vX$21 = toLeft(t23);
                        var vX$22 = vX$21;
                        res24 = natMult(natMult(deref(unbrand(vdu$0), "amount"), 24), 7);
                      } else {
                        var vX$23 = null;
                        vX$23 = toRight(t23);
                        res24 = natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60);
                      }
                      res25 = res24;
                    }
                    res26 = res25;
                ...
                if (either(t28)) {
                  ...
                  if (either(t29)) {
                    ...
                    vX$27 = toLeft(t29);
                    var vX$28 = vX$27;
                    res36 = natDiv(natDiv(natDiv(deref(unbrand(vdu$0), "amount"), 60), 60), 24);
                  } else {
                    var vX$29 = null;
                    vX$29 = toRight(t29);
                    var t30;
                    ...
                    if (either(t30)) {
                      ...
                      vX$2A = toLeft(t30);
                      var vX$2B = vX$2A;
                      res35 = natDiv(natMult(deref(unbrand(vdu$0), "amount"), 60), 24);
                    } else {
                      var vX$2C = null;
                      vX$2C = toRight(t30);
                      var t31;
                      ...
                      if (either(t31)) {
                        ...
                        vX$2D = toLeft(t31);
                        var vX$2E = vX$2D;
                        res34 = natDiv(deref(unbrand(vdu$0), "amount"), 24);
                      } else {
                        var vX$2F = null;
                        vX$2F = toRight(t31);
                        var t32;
                        ...
                        if (either(t32)) {
                          ...
                          vX$30 = toLeft(t32);
                          var vX$31 = vX$30;
                          res33 = natMult(deref(unbrand(vdu$0), "amount"), 7);
                        } else {
                          var vX$32 = null;
                          vX$32 = toRight(t32);
                          res33 = natDiv(natDiv(natDiv(deref(unbrand(vdu$0), "amount"), 60), 60), 24);
                        }
                        res34 = res33;
                      }
                      res35 = res34;
                  ...
                  if (either(t37)) {
                    ...
                    if (either(t38)) {
                      ...
                      vX$36 = toLeft(t38);
                      var vX$37 = vX$36;
                      res45 = natDiv(natDiv(natDiv(natDiv(deref(unbrand(vdu$0), "amount"), 60), 60), 24), 7);
                    } else {
                      var vX$38 = null;
                      vX$38 = toRight(t38);
                      var t39;
                      ...
                      if (either(t39)) {
                        ...
                        vX$39 = toLeft(t39);
                        var vX$3A = vX$39;
                        res44 = natDiv(natDiv(natMult(deref(unbrand(vdu$0), "amount"), 60), 24), 7);
                      } else {
                        var vX$3B = null;
                        vX$3B = toRight(t39);
                        var t40;
                        ...
                        if (either(t40)) {
                          ...
                          vX$3C = toLeft(t40);
                          var vX$3D = vX$3C;
                          res43 = natDiv(natDiv(deref(unbrand(vdu$0), "amount"), 24), 7);
                        } else {
                          var vX$3E = null;
                          vX$3E = toRight(t40);
                          var t41;
                          ...
                          if (either(t41)) {
                            ...
                            vX$3F = toLeft(t41);
                            var vX$40 = vX$3F;
                            res42 = natDiv(deref(unbrand(vdu$0), "amount"), 7);
                          } else {
                            var vX$41 = null;
                            vX$41 = toRight(t41);
                            res42 = natDiv(natDiv(natDiv(natDiv(deref(unbrand(vdu$0), "amount"), 60), 60), 24), 7);
                          }
                          res43 = res42;
                        }
                        res44 = res43;
                    ...
                    if (either(t46)) {
                      ...
                      vX$43 = toLeft(t46);
                      var vX$44 = vX$43;
                      res53 = natMult(deref(unbrand(vdu$0), "amount"), 60);
                    } else {
                      var vX$45 = null;
                      vX$45 = toRight(t46);
                      var t47;
                      ...
                      if (either(t47)) {
                        ...
                        vX$46 = toLeft(t47);
                        var vX$47 = vX$46;
                        res52 = natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60);
                      } else {
                        var vX$48 = null;
                        vX$48 = toRight(t47);
                        var t48;
                        ...
                        if (either(t48)) {
                          ...
                          vX$49 = toLeft(t48);
                          var vX$4A = vX$49;
                          res51 = natMult(natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60), 24);
                        } else {
                          var vX$4B = null;
                          vX$4B = toRight(t48);
                          var t49;
                          ...
                          if (either(t49)) {
                            ...
                            vX$4C = toLeft(t49);
                            var vX$4D = vX$4C;
                            res50 = natMult(natMult(natMult(natMult(deref(unbrand(vdu$0), "amount"), 60), 60), 24), 7);
                          } else {
                            var vX$4E = null;
                            vX$4E = toRight(t49);
