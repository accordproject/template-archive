...
const inheritance=[ {
    ...
    "sub": ("org.accordproject.cicero.contract.AccordState"), 
    "sup": ("org.accordproject.base.Asset")
  }, {
 ...
 * @param {org.accordproject.cicero.contract.AccordState} context.state - the state
 */
              ...
              __lemit = recDot(constants0, "__emit");;
              {
                let __this;
                {
                  ...
                  __this = recDot(constants0, "__contract");;
                  {
                    ...
                    {
                      ;
                      __lstate$0 = brand([ "org.accordproject.cicero.contract.AccordState" ], {
                            "stateId": ("org.accordproject.cicero.contract.AccordState#1")
                          });;
                      ret0 = {
                          "$left": (recConcat(recConcat({
                                "__response": (null)
...
function __init(context) {
  let pcontext = Object.assign(context, { 'state': { '$class': 'org.accordproject.cicero.contract.AccordState', 'stateId' : 'org.accordproject.cicero.contract.AccordState#1' } });
