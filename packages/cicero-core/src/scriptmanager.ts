...
export default class ScriptManager {
     ...
     */
    getFunctions() {
        // Bug fix found during the TS migration: the JS source called this.getAllScripts(),
        // which never existed on this class (getFunctions() would have thrown at runtime).
        // The intended method is getScripts().
