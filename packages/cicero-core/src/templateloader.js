...
class TemplateLoader extends FileLoader {
   ...
   */
  static fromGrammar(Template, modelTxt, requestStringified, data, packageStringified, logic, templatizedGrammar, readme, options) {
    return _asyncToGenerator(function* () {
      
      console.log("Started up TemplateLoader fromGrammar()");
      ...
      console.log("iterating over modelFiles");
      modelFiles.forEach(
      /*#__PURE__*/
      function () {
      ...
      const template = new (Function.prototype.bind.call(Template, null, packageStringified, readme, sampleTextFiles, requestStringified, options))(); // add model files
      console.log("done with template");
      ...
      console.log("Finished adding model files to model manager");

      Logger.debug(method, 'Setting grammar');
      console.log("Setting Grammar with template:");
      ...
      if (template.getMetadata().getRuntime() === 'ergo') {
        ...
        template.getLogicManager().addLogicFile(logic, "logic/logic.ergo");
      } else {
        console.log("Only ERGO is supported in fromGrammar()");
  ...
  static fromDirectory(Template, path, options) {
    return _asyncToGenerator(function* () {
      ...
      const readmeContents = yield TemplateLoader.loadFileContents(path, 'README.md'); // grab the request.json
