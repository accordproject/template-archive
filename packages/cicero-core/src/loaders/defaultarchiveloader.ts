...
import CompositeArchiveLoader from './compositearchiveloader';
import HTTPArchiveLoader from './httparchiveloader';
import GitHubArchiveLoader from './githubarchiveloader';
import ApArchiveLoader from './aparchiveloader';
 ...
 * @private
 */
export default class DefaultArchiveLoader extends CompositeArchiveLoader {
