...
describe('Template', () => {
    ...
    describe('#fromDirectory', () => {
        ...
        it('should roundtrip a template', async function() {
            ...
            template.getHash().should.equal('6a4c0a3673478d3638952ce8f34a293cbd71c0110883a1acb6ca69cd5c8d9e45');
    ...
    describe('#getHash', () => {
        it('should return a SHA-256 hash', async () => {
            const template = await Template.fromDirectory('./test/data/latedeliveryandpenalty');
            template.getHash().should.equal('9a25c462c82ab7a7064b33602a8f2f07c0ec65aa8cdc7a94bca3ec1207b31b3c');
        });
    });
