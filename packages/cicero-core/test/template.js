...
describe('Template', () => {
    ...
    describe('#fromDirectory', () => {
        ...
        it('should roundtrip a template', async function() {
            ...
            template.getHash().should.equal('289b4a522707cca5f471008b74baca3797339c68a799bad43c8a69b24f224a07');
    ...
    describe('#fromUrl', () => {
        ...
        it('should create a template from an archive at a given URL', async () => {
            const url = 'https://templates.accordproject.org/archives/supplyagreement@0.2.0.cta';
        ...
        it('should create a template from an archive at a given github URL', async () => {
            const url = 'github://accordproject/cicero-template-library/master/build/archives/supplyagreement@0.2.0.cta';
