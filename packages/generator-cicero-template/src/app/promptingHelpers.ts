 ...
 * @param {string} value the proposed template name
 * @return {(string|boolean)} an error message string, or true if valid
 */
export function validateTemplateName(value: string): string | boolean {
